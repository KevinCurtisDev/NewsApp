...
public final class Queries {
    ...
    public static List<CurrentNews> fetchArticlesData(String requestUrl) {
        ...
        List<CurrentNews> articles = extractFeatureFromJson(jsonResponse);
    ...
    private static List<CurrentNews> extractFeatureFromJson(String articlesJSON) {
        ...
        List<CurrentNews> articles = new ArrayList<>();
        ...
        try {
            ...
            for (int i = 0; i < articleArray.length(); i++) {
                ...
                String section = results.getString(KEY_SECTION);
                // Extract the value for the key called KEY_WEB_URL
                String url = results.getString(KEY_WEB_URL);


                CurrentNews article = new CurrentNews(title, section, url);
